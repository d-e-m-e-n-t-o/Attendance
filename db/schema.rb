...
ActiveRecord::Schema.define(version: 2021_01_28_161435) do
  ...
  create_table "bases", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_bases_on_name", unique: true
  ...
  create_table "monthapplies", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["month_first_day", "user_id"], name: "index_monthapplies_on_month_first_day_and_user_id", unique: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "basic_work_time", default: "2021-01-29 22:00:00"
    t.datetime "designated_work_start_time", default: "2021-01-30 00:00:00"
    t.datetime "designated_work_end_time", default: "2021-01-30 08:00:00"
